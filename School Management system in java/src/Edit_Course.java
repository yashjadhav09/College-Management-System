...
public class Edit_Course extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(p==0)
        {
            try {
                ...
                String value2=year.getText();
                String value3=sem.getText();
                String value4=fee.getText();
                String value5=code.getText();
              
                String sql="Update Course set Course='"+value1+"',Years='"+value2+"',Semisters='"+value3+"',Fees='"+value4+"', Code='"+value5+"' where Course='"+value1+"'";
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
           try{
            ...
            if(rs.next()){
                String add1=rs.getString("Course");
                name.setText(add1);
                String add2=rs.getString("Years");
                year.setText(add2);
                String add3=rs.getString("Semisters");
                sem.setText(add3);
                String add4=rs.getString("Fees");
                fee.setText(add4);
                String add5=rs.getString("Code");
                code.setText(add5);
