...
public class studlist extends javax.swing.JFrame {
   ...
   public  void close()
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(p==0)
        {
            String sql="delete from stud where Roll=?";
            try {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(p==0)
        {
            try {
                ...
                String value9=father.getText();
                String value10=mother.getText();
                String value11=pc.getText();
                String value12=sc.getText();
                String value13=dob.getText();
                String value14=ct.getText();
                String value15=state.getText();
                String value16=ad.getText();

                String sql="Update stud set Roll='"+value1+"',Name='"+value2+"',Gender='"+value3+"',Course='"+value4+"', Year='"+value5+"',Sem='"+value6+"',Dept='"+value7+"',Email='"+value8+"',Father='"+value9+"',cast='"+value10+"',fee='"+value11+"',StudContact='"+value12+"',DOB='"+value13+"',City='"+value14+"',State='"+value15+"',Address='"+value16+"' where Roll='"+value1+"'";
 ...
 try{
        ...
        try{
            String sql="select  * from  stud where Gender=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Course=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Year=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Sem=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Dept=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Email=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Father=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where cast=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where fee=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where StudContact=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where DOB=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where City=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where State=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
        ...
        try{
            String sql="select  * from  stud where Address=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,txt_search.getText());
